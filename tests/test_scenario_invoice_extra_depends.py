...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        activate_modules(['account_invoice_price_list', 'purchase'])
        ...
        self.assertEqual(supplier_line.unit_price, Decimal('30.00'))
        self.assertEqual(supplier_line.amount, Decimal('60.00'))
